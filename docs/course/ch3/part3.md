...
At this point, we feel compelled to apologize to the reader for not introducing another way of defining functions which is generally more concise, does not explicitly refer to any of the function arguments, and may have already been encountered accidentally.

In order to make full use of this method of creation function *trains*, we briefly introduce the commonly used / symbol. The dyadic replicate / function repeats elements of its right hand argument array by a specified left hand argument array. This allows the use of boolean masks, which makes it commonly used to filter arrays.
...
<img src="../../assets/atop.png" style="width:50%; margin-left: auto; margin-right: auto; display: block;" />
...
<img src="../../assets/beside.png" style="width:50%; margin-left: auto; margin-right: auto; display: block;" />
...
<img src="../../assets/over.png" style="width:50%; margin-left: auto; margin-right: auto; display: block;" />
...
<img src="../../assets/fork.png" style="width:50%; margin-left: auto; margin-right: auto; display: block;" />
