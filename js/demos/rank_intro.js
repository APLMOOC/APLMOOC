...
function createAxes(){
    xAxis = new THREE.ArrowHelper(new THREE.Vector3(1, 0, 0), center.clone().multiplyScalar(-0.5).add(new THREE.Vector3(-1,-1,-1)), arrowLength, 0xff0000, arrowHeadLength, arrowHeadWidth);
    yAxis = new THREE.ArrowHelper(new THREE.Vector3(0, 1, 0), center.clone().multiplyScalar(-0.5).add(new THREE.Vector3(-1,-1,-1)), arrowLength, 0x00ff00, arrowHeadLength, arrowHeadWidth);
    zAxis = new THREE.ArrowHelper(new THREE.Vector3(0, 0, 1), center.clone().multiplyScalar(-0.5).add(new THREE.Vector3(-1,-1,-1)), arrowLength, 0x0000ff, arrowHeadLength, arrowHeadWidth);
